    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <Card className="w-full max-w-lg">
        <CardHeader className="flex flex-col items-center justify-center">
          <CardTitle className="text-4xl md:text-5xl lg:text-5xl font-bold">Stopwatch</CardTitle>
        ...
        <CardContent className="flex flex-col items-center justify-center gap-8 p-4">
          ...
          <div className="text-4xl md:text-6xl sm:text-5xl lg:text-8xl font-bold">
